...
<div
    class="relative flex flex-col z-50 transition-opacity duration-500 ease-in-out mr-8 {display ? 'opacity-100 h-full' : 'opacity-0 h-0'}"
    {id}>
    <div
        class="flex max-w-sm mb-4"
        style="background: {styles[type].light} !important; color: {styles[type].text} !important;">
        <div
            class="w-16"
            style="background: {styles[type].base} !important; color: {styles[type].text} !important;">
            <div class="p-4">
                <svg
